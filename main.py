...
balls_radius = 10
balls = [(300 + np.random.uniform(-30, 30), 400 + 50 * i + 0.5 * i ** 2) for i in range(300)]
balls_body = [pymunk.Body(100.0, 1800, body_type=pymunk.Body.DYNAMIC) for b in balls]
